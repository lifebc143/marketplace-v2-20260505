...
import { Loader2, ArrowLeft, Trash2, ShoppingBag } from "lucide-react";
...
export default function AdminAllProducts() {
  ...
  // Fetch all products
  const { data: products, isLoading, refetch } = trpc.products.search.useQuery(
    {
      query: searchQuery,
      limit,
      offset,
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="border-b border-border">
        <div className="container py-4">
          ...
          <h1 className="text-3xl font-bold">所有商品管理</h1>
